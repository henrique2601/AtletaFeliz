...
import com.hydragmes.paulo.atletafeliz.extension.*
import com.hydragmes.paulo.atletafeliz.helper.*

class MainActivity : AppCompatActivity(), BottomNavigationView.OnNavigationItemSelectedListener {

    private val KEY_POSITION = "keyPosition"

    private var navPosition: BottomNavigationPosition = BottomNavigationPosition.ATLHETELIST
    ...
    private fun restoreSaveInstanceState(savedInstanceState: Bundle?) {
        ...
        savedInstanceState?.also {
            val id = it.getInt(KEY_POSITION, BottomNavigationPosition.ATLHETELIST.id)
    ...
    private fun initFragment(savedInstanceState: Bundle?) {
        savedInstanceState ?: switchFragment(BottomNavigationPosition.ATLHETELIST)
    }
